...
import pubsher.talexsoultech.particlelib.utils.matrix.Matrix;
...
public abstract class ParticleObject {
    ...
    public void alwaysShow() {
        ...
        Bukkit.getScheduler().runTaskLater(TalexSoulTech.getInstance(), () -> {
            running = true;
            ...
            }.runTaskTimer(TalexSoulTech.getInstance(), 0L, period);
    ...
    public void alwaysShowAsync() {
        ...
        Bukkit.getScheduler().runTaskLater(TalexSoulTech.getInstance(), () -> {
            ...
            }.runTaskTimerAsynchronously(TalexSoulTech.getInstance(), 0L, period);
    ...
    public ParticleObject attachEntity(Entity entity) {
        ...
        }.runTaskTimerAsynchronously(TalexSoulTech.getInstance(), 2, getPeriod());
        return this;
    }
