...
public class CompressStick4 extends SoulTechItem {

    public CompressStick4() {

        super("compress_stick4", new ItemBuilder(Material.STICK).setName("§f三级压缩木棒").setLore("", "§8> §f挺硬的..", "").toItemStack());
    }

    @Override
    public WorkBenchRecipe getRecipe() {

        return new WorkBenchRecipe("compress_stick4", this)

                .addRequired("compress_log3")
                .addRequired("compress_log3")
                .addRequired("compress_log3")
                .addRequired("compress_stick3")
                .addRequired("compress_log3")
                .addRequired("compress_stick3")
                .addRequired("compress_log3")
                .addRequired("compress_log3")
