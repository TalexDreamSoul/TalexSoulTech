...
public class CompressStick extends SoulTechItem {

    public CompressStick() {

        super("compress_stick", new ItemBuilder(Material.STICK).setName("§f压缩木棒").setLore("", "§8> §f挺硬的..", "").toItemStack());
    }

    public WorkBenchRecipe getRecipe() {

        return new WorkBenchRecipe("compress_stick", this)

                .addRequiredNull()
                .addRequired(new MineCraftItem(Material.STICK))
                .addRequiredNull()
                .addRequired(new MineCraftItem(Material.STICK))
                .addRequiredNull()
                .addRequired(new MineCraftItem(Material.STICK))
