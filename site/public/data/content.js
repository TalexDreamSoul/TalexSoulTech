export const SITE_CONTENT = {
  ...
  overview: {
    ...
    implemented: [
      ...
      {
        title: "已经确认的物品与材料线",
        detail: "当前包含压缩系列、破碎锤与破碎链、筛网、火焰材料、超级骨粉与超级线、种子与蘑菇、树脂、电气部件、火力发电与储能、储罐、防具、法杖、展示器、注能核心、空间尘、末地石尘。",
      },
      {
        title: "五类已注册机器",
        detail: "高级工作台、破碎锤机器、压缩机、炉釜机器、烤盘机器由机器管理器在启动阶段注册并进入统一事件检查入口。",
      },
      {
        title: "可持久化的玩家状态",
    ...
    boundaries: [
      "27 学科与 810 物品是完整策划容量，不是当前已实装数量；未列为已实现的学科、物品、配方与机器均处于规划中。",
      "一期不把设计概念伪装成可下载内容。本站只展示当前 Maven 构建产物信息，不提供未经确认的公网下载地址。",
  ...
  download: {
    title: "下载与产物说明",
    availability: "受控构建产物分发",
    artifact: "talex-soul-tech-3.0.0-SNAPSHOT.jar",
    detail: "当前 Maven 坐标为 com.talexdreamsoul:talex-soul-tech:3.0.0-SNAPSHOT，打包名由 Maven finalName 固定为 talex-soul-tech-3.0.0-SNAPSHOT.jar。本站不捏造公网下载链接，也不把聊天附件或未知镜像当作发行渠道。",
    steps: [
      "从项目受控构建流程取得与当前提交对应的 JAR，并保留构建来源与版本记录。",
      "将 JAR 放入目标 Paper 服务端的 plugins 目录；不要覆盖未备份的旧产物或数据目录。",
      "先完成 Java、Paper 与 MySQL 前置检查，再允许玩家进入服务器。",
      "启动后使用 /tst 查看插件命令入口；云端能力保持关闭，直到完成一次有效配对。",
    ],
    integrityRule: "没有明确发布工件时，不应向玩家展示下载按钮或猜测 URL。",
  },
  quickInstall: {
    title: "快速安装",
  ...
  planning: {
    title: "27 学科与 810 物品：策划原则，不伪装为现状",
    lead: "一期已经落地 8 个学科根目录。27 学科与 810 物品描述的是完整内容版图的容量目标：每一门学科必须有输入、处理、产出、回收与明确边界，不能只为凑数量新增名称。",
    accounting: {
      implementedRoots: 8,
      plannedRoots: 19,
      plannedItemCapacity: 810,
      clarification: "810 不是当前物品计数，也不是对发布日期、配方数量或掉落概率的承诺。",
    },
    curriculum: [
      { order: 1, name: "基础", state: "已实现", role: "基础制作、压缩与入门配方。" },
      { order: 2, name: "材料", state: "已实现", role: "材料转化与火焰材料。" },
      { order: 3, name: "植物", state: "已实现", role: "种子、蘑菇与生长辅助。" },
      { order: 4, name: "防御", state: "已实现", role: "防具与生存保护。" },
      { order: 5, name: "科技", state: "已实现", role: "树脂、电气部件、机器与能源。" },
      { order: 6, name: "魔法", state: "已实现", role: "法杖、展示器与注能核心。" },
      { order: 7, name: "空间", state: "已实现", role: "空间尘、末地石尘与空间侧配方。" },
      { order: 8, name: "引力", state: "已实现", role: "引力相关物件与后段交叉入口。" },
      { order: 9, name: "地质", state: "规划中", role: "未来的矿物勘探方向；不代表当前已有物品或配方。" },
      { order: 10, name: "农业工程", state: "规划中", role: "未来的规模化种植方向；不代表当前已有物品或配方。" },
      { order: 11, name: "食品工艺", state: "规划中", role: "未来的食物处理方向；不代表当前已有物品或配方。" },
      { order: 12, name: "热能", state: "规划中", role: "未来的热处理方向；不代表当前已有物品或配方。" },
      { order: 13, name: "流体", state: "规划中", role: "未来的液体管理方向；不代表当前已有物品或配方。" },
      { order: 14, name: "物流", state: "规划中", role: "未来的物品输送方向；不代表当前已有物品或配方。" },
      { order: 15, name: "自动化", state: "规划中", role: "未来的自动处理方向；不代表当前已有物品或配方。" },
      { order: 16, name: "信息", state: "规划中", role: "未来的状态与控制方向；不代表当前已有物品或配方。" },
      { order: 17, name: "生态", state: "规划中", role: "未来的环境互动方向；不代表当前已有物品或配方。" },
      { order: 18, name: "机械构造", state: "规划中", role: "未来的结构化机器方向；不代表当前已有物品或配方。" },
      { order: 19, name: "化学", state: "规划中", role: "未来的反应与材料分离方向；不代表当前已有物品或配方。" },
      { order: 20, name: "冶炼", state: "规划中", role: "未来的金属处理方向；不代表当前已有物品或配方。" },
      { order: 21, name: "光学", state: "规划中", role: "未来的观测与光能方向；不代表当前已有物品或配方。" },
      { order: 22, name: "声学", state: "规划中", role: "未来的信号与环境互动方向；不代表当前已有物品或配方。" },
      { order: 23, name: "时间", state: "规划中", role: "未来的周期与进程方向；不代表当前已有物品或配方。" },
      { order: 24, name: "生物", state: "规划中", role: "未来的生物改造方向；不代表当前已有物品或配方。" },
      { order: 25, name: "航行", state: "规划中", role: "未来的移动与远征方向；不代表当前已有物品或配方。" },
      { order: 26, name: "维度工程", state: "规划中", role: "未来的跨维度设施方向；不代表当前已有物品或配方。" },
      { order: 27, name: "终局工程", state: "规划中", role: "未来的长期目标方向；不代表当前已有物品或配方。" },
    ],
    principles: [
